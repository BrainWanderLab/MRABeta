...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', type=str, default='./data', help='data root')     #'./dataallsmsc'
        self.parser.add_argument('--savepath', type=str, default='./result', help='savepath')
        self.parser.add_argument('--nEpoch', type=int, default=60, help='number of Epoch iteration')
        ...
        self.parser.add_argument('--disp_div_N', type=int, default=6, help=' display N per epoch')  #6
        self.parser.add_argument('--nB', type=int, default=1, help='input batch size')#1 
        ...
        self.parser.add_argument('--name', type=str, default='AV45', help='name of the experiment. It decides where to store samples and models')  #ccamnew
        ...
        self.parser.add_argument('--lambda_l1_cyc', type=float, default=10., help='lambda_L1_cyc, StarGAN cyc loss rec') #1
        self.parser.add_argument('--lambda_l2_cyc', type=float, default=0., help='lambda_L2_cyc, StarGAN cyc loss rec')
        self.parser.add_argument('--lambda_ssim_cyc', type=float, default=1., help='lambda_ssim')   #10
        
        self.parser.add_argument('--lambda_l2', type=float, default=0., help='lambda_L2')
        self.parser.add_argument('--lambda_l1', type=float, default=10, help='lambda_L1')  #10
        ...
        self.parser.add_argument('--nEpochDclsf', type=int, default=20, help='# of nEpoch for Discriminator pretrain')  #20   ccam 0
        self.parser.add_argument('--nCh_D', type=int, default=4, help='# of ngf for Discriminator')  #64
        self.parser.add_argument('--nCh_C', type=int, default=16, help='# of ngf for Classifier')
        self.parser.add_argument('--use_lsgan', action='store_false', help='use lsgan, if not defualt GAN')
        ...
        self.parser.add_argument('--N_null', type=int, default=5, help = '1-5')
        self.parser.add_argument('--nEpochD', type=int, default=2, help = 'nEpochD update while 1 G update')
        self.parser.add_argument('--train_fig',type=str, default='./result_model', help='savepath')
        self.parser.add_argument('--test_fig',type=str, default='./result_fig', help='savepath')
        self.parser.add_argument('--test_ssim',type=str, default='./result_ssim', help='savepath')
