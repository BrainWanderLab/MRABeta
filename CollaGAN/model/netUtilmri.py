...
def UnetINDiv4_CCAM(inp, n_out, is_Training, reg_=[], nCh=64, name_='', _1x1Conv=False, use_bias=True):
    ...
    einp = tf.concat( [  inp[:,4:5,:,:],mask],axis=ch_dim)
    finp = tf.concat( [  inp[:,5:6,:,:],mask],axis=ch_dim)
    anCh = nCh/4
    ...
    '''e path''' 
    edown0_1     =    CNR(  dinp,      anCh,  name=name_+'elv0_1', reg=reg_, use_bias=use_bias)
    edown0_2     =    CNR(  edown0_1,  anCh,  name=name_+'elv0_2', reg=reg_, use_bias=use_bias)
    epool1       = Pool2d(  edown0_2,  anCh*2,name=name_+'elv1_p') 
    edown1_1     =    CNR(  epool1,    anCh*2,name=name_+'elv1_1', reg=reg_, use_bias=use_bias) 
    edown1_2     =    CNR(  edown1_1,  anCh*2,name=name_+'elv1_2', reg=reg_, use_bias=use_bias)
    epool2       = Pool2d(  edown1_2,  anCh*4,name=name_+'elv2_p')
    edown2_1     =    CNR(  epool2,    anCh*4,name=name_+'elv2_1', reg=reg_, use_bias=use_bias) 
    edown2_2     =    CNR(  edown2_1,  anCh*4,name=name_+'elv2_2', reg=reg_, use_bias=use_bias)
    epool3       = Pool2d(  edown2_2,  anCh*8,name=name_+'elv3_p')
    edown3_1     =    CNR(  epool3,    anCh*8,name=name_+'elv3_1', reg=reg_, use_bias=use_bias) 
    edown3_2     =    CNR(  edown3_1,  anCh*8,name=name_+'elv3_2', reg=reg_, use_bias=use_bias)
    epool4       = Pool2d(  edown3_2,  anCh*16, name=name_+'elv4_p')

    '''f path'''
    fdown0_1     =    CNR(  dinp,      anCh,  name=name_+'flv0_1', reg=reg_, use_bias=use_bias)
    fdown0_2     =    CNR(  fdown0_1,  anCh,  name=name_+'flv0_2', reg=reg_, use_bias=use_bias)
    fpool1       = Pool2d(  fdown0_2,  anCh*2,name=name_+'flv1_p') 
    fdown1_1     =    CNR(  fpool1,    anCh*2,name=name_+'flv1_1', reg=reg_, use_bias=use_bias) 
    fdown1_2     =    CNR(  fdown1_1,  anCh*2,name=name_+'flv1_2', reg=reg_, use_bias=use_bias)
    fpool2       = Pool2d(  fdown1_2,  anCh*4,name=name_+'flv2_p')
    fdown2_1     =    CNR(  fpool2,    anCh*4,name=name_+'flv2_1', reg=reg_, use_bias=use_bias) 
    fdown2_2     =    CNR(  fdown2_1,  anCh*4,name=name_+'flv2_2', reg=reg_, use_bias=use_bias)
    fpool3       = Pool2d(  fdown2_2,  anCh*8,name=name_+'flv3_p')
    fdown3_1     =    CNR(  fpool3,    anCh*8,name=name_+'flv3_1', reg=reg_, use_bias=use_bias) 
    fdown3_2     =    CNR(  fdown3_1,  anCh*8,name=name_+'flv3_2', reg=reg_, use_bias=use_bias)
    fpool4       = Pool2d(  fdown3_2,  anCh*16, name=name_+'flv4_p')
    
    ''' decoder '''
    pool4 = tf.concat([apool4,bpool4,cpool4,dpool4,epool4,fpool4], axis=ch_dim)
    ...
    down3_2 = tf.concat([adown3_2,bdown3_2,cdown3_2, ddown3_2,edown3_2,fdown3_2], axis=ch_dim)
    ...
    down2_2 = tf.concat([adown2_2,bdown2_2,cdown2_2, ddown2_2,edown2_2,fdown2_2], axis=ch_dim)
    ...
    down1_2 = tf.concat([adown1_2,bdown1_2,cdown1_2,ddown1_2,edown1_2,fdown1_2], axis=ch_dim)
    ...
    down0_2 = tf.concat([adown0_2,bdown0_2,cdown0_2,ddown0_2,edown0_2,fdown0_2], axis=ch_dim)
